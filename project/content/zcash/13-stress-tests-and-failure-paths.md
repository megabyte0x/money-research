...
**All numerical shocks below are invented stress scenarios.** They are not forecasts, observed ZEC returns, or estimates of failure probability. The purpose is to test whether the system in [11](11-hypothesis-a-world-ready-for-zec.md) and [12](12-hypothesis-adoption-roadmap-and-worked-example.md) can keep its promises.
...
**Scenario:** parts of the shielded system must be paused, patched, or migrated while payroll and business payments are due. The historical 2026 response shows why this category deserves explicit planning; the scenario does not assert a new flaw. See [10](10-zcash-specific-risks-and-governance.md).
