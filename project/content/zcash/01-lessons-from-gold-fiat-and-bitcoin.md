...
Together they produce a better question than “Which coin is best?”: **which arrangement performs which monetary function, who guarantees its promises, and who takes the loss when it fails?** The [coverage map](18-prior-document-coverage.md) links every prior document to this volume.
...
In present banking, loans can also create deposits. The base and broad money are distinct. The Bank of England explains the relevant balance sheets and the limits on commercial-bank money creation. [M01](17-sources-and-evidence-register.md#m01) The hypothetical ZEC arrangements in [06](06-fixed-supply-credit-and-crisis-management.md) specify which kind of credit is permitted.
...
Bitcoin proof-of-work confirmations increase confidence; they do not create unconditional, clock-timed irreversibility. Its payment documentation explicitly discusses competing spends and confirmation depth. [M13](17-sources-and-evidence-register.md#m13) The same distinction matters for Zcash's proof-of-work settlement.
...
The Great Inflation began before the 1971 gold-window closure; the Federal Reserve dates it to 1965–1982. Policy, expectations, institutions, and supply shocks all belong in the explanation. [M14](17-sources-and-evidence-register.md#m14) Credit crises and war finance also existed under metallic systems.
...
The Basel crypto framework has a 1 January 2026 effective date in the checked international standard; domestic implementation is a separate question. A 1,250% risk weight is not a 1,250% tax. [M07](17-sources-and-evidence-register.md#m07)
