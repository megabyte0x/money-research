...
Present banking illustrates the distinction: a new loan can create a matching deposit, while interbank payments require settlement assets. Banks are constrained by capital, liquidity, profitability, risk, regulation, and borrower demand. [M01](17-sources-and-evidence-register.md#m01)
...
All three permit lending. The second design is used for the central hypothesis in [11](11-hypothesis-a-world-ready-for-zec.md), because it makes the difference between spendable money and risky investment especially explicit. It is a proposed institutional choice, not a description of today's Zcash ecosystem.
...
Weber's Bitcoin-standard working paper conjectures mild deflation under its assumptions and retains a limited lender-of-last-resort role. It is a conditional model, not a proof that all hard-money economies behave identically or an official Bank of Canada endorsement. [M02](17-sources-and-evidence-register.md#m02)
