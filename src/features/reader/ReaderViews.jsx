...
export function MethodsPage() {
  return <div className="intro-page reader-methods">
    <p className="eyebrow">Research method</p><h1>Scope and sources</h1>
    <p>The library contains 44 research documents in three volumes: gold, the post-1971 monetary system and Bitcoin. It presents their arguments while historical, legal and market claims remain under editorial review. Dated observations are not live figures.</p>
    <p>Each volume has a source page. Some entries still need exact document and passage locations; follow the links on those pages to inspect the material behind a claim.</p>
    <ul><li><a href="/gold/12-sources/">Gold source page →</a></li><li><a href="/after/13-sources/">After Gold source page →</a></li><li><a href="/bitcoin/16-sources/">Bitcoin source page →</a></li></ul>
    <p>The comparison is a qualitative guide. Historical arc charts are withheld while their datasets are checked. Substantive revisions should identify the affected chapter and passage so readers can distinguish updated claims from earlier wording.</p>
  </div>;
}
